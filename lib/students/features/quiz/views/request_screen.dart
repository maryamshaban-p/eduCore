              ...
              child: _actionInProgress
                  ...
                  : CustomDataTable(
                      ...
                      columns: const [
                        ...
                        TableColumnDef(label: 'Count',   widthFactor: 0.07),
                        TableColumnDef(label: 'Reason',  widthFactor: 0),
                        TableColumnDef(label: 'Date',    widthFactor: 0.11),
                        TableColumnDef(label: 'Action',  widthFactor: 0.22), // ← wider
                      ],
                      rows: _current.map((r) => [
                        TableCellData(
                          widthFactor: 0,
                        ...
                        TableCellData(
                          widthFactor: 0.22, // ← matches column
