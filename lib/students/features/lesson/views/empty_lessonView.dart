...
class EmptyLessonviewScreen extends StatelessWidget {
  const EmptyLessonviewScreen({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: Text('Course name' , style: AppStyles.primary30.copyWith(
                 ...
                 CoursesTabsBar(screenWidth: screenWidth, selectedTab: LessonTab.lesson, colorname: AppColors.lightGrayBlue,),
                 SizedBox(height: screenHeight * 0.06),
                 Column(
                   children: [
                     Image.asset(AppImages.empty_image, width: screenWidth,),
                     SizedBox(height: screenHeight * 0.02),
                     Text('Empty', style: AppStyles.coalGray.copyWith(
                      fontSize: 28
                     ))
                   ],
                 )
