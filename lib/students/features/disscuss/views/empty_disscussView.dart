...
class EmptyDisscussview extends StatelessWidget {
  const EmptyDisscussview({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // CoursesTabsBar(screenWidth: screenWidth, selectedTab: LessonTab.discuss, colorname: AppColors.lightGrayBlue,),
                // SizedBox(height: screenHeight * 0.06),
                 Column(
                   children: [
